/**
 * Generates all PWA icon sizes for the frontend.
 * Run from backend folder: node scripts/generate-icons.js
 */
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <circle cx="256" cy="256" r="180" fill="none" stroke="#00e639" stroke-width="8" opacity="0.25"/>
